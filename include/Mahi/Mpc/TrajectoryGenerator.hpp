...
private:
    ...
    int m_trial_num;  // what trial number we are on
    casadi::Function m_solver; // what solver do we want to use (i use ipopt)
    
public:
    //Function generator construction and associated public functions
